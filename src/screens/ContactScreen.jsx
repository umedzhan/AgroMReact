        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-green-50 p-8 rounded-lg mb-12 text-center bg-[url('/images/breadcrumb.jpg')] bg-cover bg-center relative">
                <div className="relative z-10">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">{tUZ("Biz bilan bog'lanish")}</h1>
                    <div className="flex justify-center space-x-2 text-sm text-gray-500">
                        <Link to="/" className="hover:text-brand">{tUZ("Bosh sahifa")}</Link>
                        <span>/</span>
                        <span className="text-brand font-medium">{tUZ("Biz bilan bog'lanish")}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{tUZ("Manzil")}</h3>
                    <p className="text-gray-500">
                        {tUZ("Termiz, Surxondaryo, O'zbekiston")}
                    </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{tUZ("Elektron pochta manzili")}</h3>
                    <p className="text-gray-500">
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{tUZ("Telefon raqami")}</h3>
                    <p className="text-gray-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white p-8 lg:p-12 rounded-2xl shadow-lg border border-gray-100">
                ...
                <div>
                    ...
                    <p className="text-gray-500 mb-8">{tUZ("Savollaringiz bormi? Biz sizdan eshitishdan xursand bo'lamiz.")}</p>

                    <form className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <input type="text" placeholder={tUZ("Ismingiz")} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" />
                            </div>
                            <div>
                                <input type="email" placeholder={tUZ("Elektron pochtangiz")} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" />
                            </div>
                        </div>
                        <div>
                            <input type="text" placeholder={tUZ("Mavzu")} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all" />
                        </div>
                        <div>
                            <textarea rows="5" placeholder={tUZ("Xabar")} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all resize-none"></textarea>
                        </div>
